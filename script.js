/*=========================================================constants ======================================================*/
// let's assign a color to each player
const COLORS = {
    '0': 'white',
    '1': 'purple',
    '-1': 'orange'
  ...
  /*=====================================state variables ==================================================================*/
  // different variables used during the game

  let turn; // for each player allowed to participate 1 or -1
  let board; // the field which will be a 2d array of 7 arrays with six values
  let winner; // the result at the end of each game which could be null, 1, -1 or 'T'
  
  /*======================================cached elements =====================================================================*/
  // elements catched to stay on track
  ...
  function handleDrop(evt) {
    ...
    colArr[rowIdx] = turn;
    // 5) To toggle the turn 
    turn *= -1;
    // 6) To update the winner - verify if we have a winner
  ...
  // variable to keep track of the player we are counting disks for
 ...
 // variable to keep track of the count
    ...
    while (
      ...
      // while counting:
      // Be sure we stay within the bounds of the game board
      // Be sure the current disk we're checking is for the same player
      // count
      count++
      // To update coords
      colIdx += colOffset;
    ...
    // the ability to return the count
    return count;
  }
  
  
  
  // the ability to transfer the state of our work state to the DOM
  function render() {
    renderBoard();
    renderMessage();
    renderControls();
